...
@section('title', 'Détail Offre Emploi')
        ...
        <div class="col-md-12">
            <div class="mt-2 card card-default">
                <div class="card-header">
                    <h3 class="card-title"><span class="float-left">Détail de l'offre: {{$offre->titre}}</span></h3>
                    <span class="float-right"><a href="{{route('admin.offres.list')}}">Retour</a></span>
                    </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
