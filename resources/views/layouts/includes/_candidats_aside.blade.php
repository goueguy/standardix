    ...
    <div class="flex flex-wrap items-stretch justify-center ">
        <div class="flex flex-col items-center justify-center">
            <div class="w-16 h-16 mt-5 ">
                <img src="{{asset('assets/images/avatar.svg')}}" class="rounded-full bg-white">
            </div>
        ...
        <div class="flex flex-col p-10 mt-10 mb-0 text-white text-md">
            ...
            <a href="{{route('candidats.parametres')}}" class="flex flex-row px-2 my-2 hover:opacity-75">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <footer class="flex flex-row justify-center text-xs text-white">
            <span class="flex flex-row px-5 mt-12 hover:opacity-75">
