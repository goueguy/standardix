<div class="w-1/4 px-4 space-y-6 sidebar bg-primary align-items-center ">
    ...
    <div class="flex flex-wrap items-stretch justify-center ">
        ...
        @else
        <div class="flex flex-col p-10 mt-10 mb-0 text-white text-md">
            <a href="{{route('candidats.dashboard')}}" class="flex flex-row px-2 my-2 hover:opacity-75">
            ...
            <a href="{{route('candidats.candidatures')}}" class="flex flex-row px-2 my-2 hover:opacity-75">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="{{route('candidats.notifications')}}" class="flex flex-row px-2 my-2 hover:opacity-75">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 4H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-2m-4-1v8m0 0l3-3m-3 3L9 8m-5 5h2.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.707.293h3.172a1 1 0 00.707-.293l2.414-2.414a1 1 0 01.707-.293H20" />
                </svg>
                <span class="ml-3">Mes Messages</span>
            </a>
