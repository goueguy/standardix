    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                ...
                <ul class="ml-3 nav nav-treeview">
                    <li class="nav-item">
                    <a href="{{route('admin.candidatures.list')}}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-sm text-white nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                            </svg>
            ...
            <li class="nav-item">
                ...
                <ul class="ml-3 nav nav-treeview">
                    <li class="nav-item">
                    <a href="{{route('admin.offres.list')}}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-sm text-white nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                        </svg>
                    ...
                    <li class="nav-item">
                    <a href="{{route('admin.offres.add')}}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-sm text-white nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                    ...
                    <li class="nav-item">
                    <a href="{{route('admin.offres.lancees')}}" class="nav-link">
            ...
            <li class="nav-item">
                ...
                <ul class="ml-3 nav nav-treeview">
                    <li class="nav-item">
                    <a href="{{route('admin.domaine.create')}}" class="nav-link">
            ...
            <li class="nav-item">
                ...
                <ul class="ml-3 nav nav-treeview">
                    <li class="nav-item">
                    <a href="{{route('admin.users.profil')}}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-sm text-white nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li class="nav-item">
                    <a href="{{route('admin.users.password')}}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-sm text-white nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
