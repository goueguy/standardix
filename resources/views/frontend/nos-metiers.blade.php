            ...
            <div class="">
                <form action="">
                    ...
                    <div class="px-32 mb-10">
                        <button type="submit" name="valider" class="mt-5  rounded-full shadow-md text-center py-3 font-bold  text-md px-28  focus:outline-none btn_connect transition duration-500">Connecter</button>
                    </div>
                </form>
            </div>
            <div class="w-1/3">
