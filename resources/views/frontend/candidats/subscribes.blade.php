...
@section('title',"Candidats::Candidatures")
@section('content')

<h2 class="p-2 mb-5 mt-8 font-bold bg-green-100 border-l-4 border-green-600"> <span class="pl-2">MES CANDIDATURES</span></h2>
    <div class="flex justify-center mt-3">
        ...
        @else
            <div class="flex max-w-sm mb-4 bg-teal-lighter">
                ...
                <div class="shadow text-center items-center w-auto p-4 text-grey-darker">
