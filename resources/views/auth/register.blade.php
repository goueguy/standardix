        ...
        <div class="mx-auto text-center pt-36">
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="flex flex-row justify-between p-4 mb-4 bg-white  @error('nom') border border-red-600 @enderror rounded-lg shadow w-90">
                    <input type="text" name="nom" class="border-0 focus:outline-none md:focus:placeholder-green-600" name="nom" placeholder="Votre nom" value="{{old('nom')}}"/>
                    @error('nom')
                ...
                <div class="flex flex-row justify-between p-4 mb-4 bg-white  @error('prenoms') border border-red-600 @enderror rounded-lg shadow w-90">
                    <input type="text" name="prenoms" class="border-0 focus:outline-none md:focus:placeholder-green-600" name="prenoms" placeholder="Votre prénoms" value="{{old('prenoms')}}"/>
                    @error('prenoms')
                    <span class="text-red-600" title="{{$message}}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                <div class="flex flex-row justify-between p-4 bg-white @error('email') border border-red-600 @enderror rounded-lg shadow w-90">
                    <input type="password" name="password_confirmation" class="border-0 focus:outline-none md:focus:placeholder-green-600" name="email" placeholder="*************************" value="{{old('password')}}"/>
                    @error('password')
                        <span class="text-red-600" title="{{$message}}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
